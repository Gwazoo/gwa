...
module.exports = function () {
	...
	var upgradeButton = "#FD8730";
	var percentText = "#37B34A";
	var linkText = "#FD8730";
	...
	<head>
	  ...
	  <title>Gwazoo Discount Offer</title>
	    ...
	    <td align='center' valign='top' width='100%' style='background-color: #f7f7f7;' class='content-padding'>
	      <center>
	        <table cellspacing='0' cellpadding='0' width='600' class='w320'>
	          <tr>
	            <td class='header-lg'>
	              Upgrade now <br /> and receive <span style='color: ${percentText};'>20%</span> off!
	            </td>
	          </tr>
	          <tr>
	            <td class='free-text'>
	          ...
	          <tr>
	            <td class='button'>
	              <div><!--[if mso]>
	                <v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' href='http://' style='height:45px;v-text-anchor:middle;width:155px;' arcsize='15%' strokecolor='#ffffff' fillcolor='${upgradeButton}'>
	                  <w:anchorlock/>
	              ...
	              style='background-color:${upgradeButton};border-radius:5px;color:#ffffff;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;'>Upgrade</a></div>
	            </td>
	          </tr>
	        </table>
	      </center>
	                      ...
	                      <td class='block-rounded'>
	                        <table cellpadding='0' cellspacing='0' width='100%'>
	                          ...
	                          <tr>
	                            <td style='padding: 15px;'>
	                              <div><!--[if mso]>
	                                <v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' href='http://' style='height:45px;v-text-anchor:middle;width:228px;' arcsize='15%' strokecolor='#ffffff' fillcolor='${buttonColor}'>
	                                  <w:anchorlock/>
	                                  <center style='color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;'>My Account</center>
	                                </v:roundrect>
	                              <![endif]--><a class='button-width' href='http://'
	                              style='background-color:${buttonColor};border-radius:5px;color:#ffffff;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all;'>View Now!</a></div>
	                            </td>
	                          </tr>
	                        </table>
	                      </td>
	                        ...
	                        <table cellpadding='0' cellspacing='0' width='100%'>
	                          ...
	                          <tr>
	                            <td style='padding: 15px;'>
	                              ...
	                              <![endif]--><a class='button-width' href='http://'
	                              style='background-color:${buttonColor};border-radius:5px;color:#ffffff;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:228px;-webkit-text-size-adjust:none;mso-hide:all;'>View Now!</a></div>
	                            </td>
	                          </tr>
	                        </table>
	                      </td>
