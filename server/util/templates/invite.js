	    ...
	    <td align='center' valign='top' width='100%' style='background-color: #f7f7f7;' class='content-padding'>
	      <center>
	        <table cellspacing='0' cellpadding='0' width='600' class='w320'>
	          ...
	          <tr>
	            <td class='free-text'>
	              <span><a href=''>@JaneDoe</a></span> has invited you to join Gwazoo!
	            </td>
	          </tr>
	          <tr>
	            <td class='mini-block-container'>
	                    ...
	                    <table cellpadding='0' cellspacing='0' width='100%'>
	                      ...
	                      <tr>
	                        <td class='button'>
	                          ...
	                          <![endif]--><a href='http://'
	                          style='background-color:${buttonColor};border-radius:5px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;'>Sign Up</a></div>
	                        </td>
	                      </tr>
	                    </table>
	                  </td>
