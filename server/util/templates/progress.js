	                    ...
	                    <table cellpadding='0' cellspacing='0' width='100%'>
	                      ...
	                      <tr>
	                        <td class='button'>
	                          ...
	                          <![endif]--><a href='http://'
	                          style='background-color:${buttonColor};border-radius:5px;color:#ffffff;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;'>Update Account</a></div>
	                        </td>
	                      </tr>
	                    </table>
	                  </td>
